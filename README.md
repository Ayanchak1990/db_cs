# deltek_control_schema

The 'deltek_control_schema' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/deltek_control_schema/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] deltek_control_schema_etl` to your workspace.
